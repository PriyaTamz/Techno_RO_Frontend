      ...
      <div className="flex border space-x-6 border-[#CACACA] md:p-[24px]">
        ...
        <div className="md:w-[650px] md:h-[600px] ">
          ...
          <p className="text-[22px] text-justify text-[#263138] ">
            ...
            industry, we specialize in providing reliable and efficient RO
            services for both residential and commercial needs.
            <br />
            Our team of skilled professionals is dedicated to offering top-notch
            installation, maintenance, and repair services for RO systems,
            designed to meet the unique needs of each customer. We use advanced
            technology and high-grade components to guarantee the highest level
            of purification, ensuring that your water is free from contaminants
            and meets all health standards.
            <br />
            <br />
            At Techno RO, we believe that clean water is essential for a healthy
      ...
      <div className=" mx-auto p-6 text-gray-800">
        ...
        <section className=" p-2 ">
          ...
          <p className="h-[72px ] text-[22px]  md:mt-3">
            Our mission is to provide every customer with pure, fresh water,
            helping to improve the quality of life for our community, one drop
            at a time.
          </p>
        </section>
        ...
        <section className="mt-8  p-2">
          <h2 className="text-2xl font-semibold text-[25px]">
            Awards and Certifications
          </h2>
          <p className=" text-[22px] md:mt-3">
            We are proud to be certified by [Certification Body], recognized for
            our commitment to excellence in water treatment and purification
            services.
          </p>
        </section>
        ...
        <section className="mt-8 p-2">
          ...
          <p className=" text-[22px] md:mt-3">
            Ready to experience the benefits of purified water? Get in touch
            with us today for a free consultation, and let us help you find the
            perfect solution for your water needs.
          </p>
          <div className="flex justify-center gap-2 mt-4">
            ...
            />
            <button className="bg-[#7EC1B1] text-white px-4 py-2 rounded-md">
              Get in Touch
            </button>
          </div>
        </section>

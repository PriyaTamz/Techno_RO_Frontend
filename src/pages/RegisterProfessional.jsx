    ...
    <div className="flex w-full flex-col items-center p-6">
      <div className="flex justify-center mt-4">
        <div className="flex flex-col w-[419px] space-y-3 justify-center">
          ...
          <p className="text-center text-[24px] text-[#263138] mt-2">
            Join 50,000+ partners across India.
          </p>
        </div>
      ...
      <p className="text-center text-[24px] text-[#606060] mt-2">
        Techno RO is an app-based marketplace that empowers professionals like
        you to become your own boss
      </p>
      <div className="flex justify-between gap-6 mt-6 text-center">
        <div className="flex flex-col space-y-3 items-center">
          ...
          <p className="text-[#263138] text-[20px]">
        ...
        <div className="flex flex-col space-y-3 items-center">
          ...
          <p className="text-[#7EC1B1] text-[24px] font-bold">₹1500Cr</p>
          <p className="text-[#263138] text-[20px]">

...
const ChatWithUs = () => {
  const [messages, setMessages] = useState([
    {
      ...
      sender: "user",
      img: userImg,
      text: "Lorem ipsum dolor sit amet consectetur. Turpis vivamus pretium ac diam vitae cursus.",
      time: "06:30 AM",
    },
    {
      id: 2,
  ...
  return (
    <div className="flex flex-col  md:mx-[100px] mt-5 ">
      <h1 className="text-[20px] font-semibold md:mb-8 ">
      ...
      <div className="flex space-x-2 items-center">
        ...
        <p className="text-gray-500 space-x-3 text-sm flex items-center mt-2">
          Typing...
        </p>
      </div>
